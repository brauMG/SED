...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="td-card"> <input id="level1" type="text"
                                                                    class="form-control <?php $__errorArgs = ['level1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="td-card"> <input id="level2" type="text"
                                                                    class="form-control <?php $__errorArgs = ['level2'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="td-card"> <input id="level3" type="text"
                                                                    class="form-control <?php $__errorArgs = ['level3'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="td-card"> <input id="level4" type="text"
                                                                    class="form-control <?php $__errorArgs = ['level4'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="td-card"> <input id="level5" type="text"
                                                                    class="form-control <?php $__errorArgs = ['level5'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ICA/resources/views/admins/maturity/addML/create.blade.php ENDPATH**/ ?>