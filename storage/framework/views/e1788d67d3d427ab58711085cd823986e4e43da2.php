            ...
            <section class="addArea">
                <div class="justify-content-center">
                    <div class="card card-add-company">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('UpdateArea',[$area->areaId])); ?>" id="formEditArea">
                                ...
                                <table class="table-responsive table-card-inline" id="tAdmin">
                                    <tr class="tr-card-complete">
                                        ...
                                        <td class="td-card">
                                            <input type="text" name="name" id="areaEdi" class="form-control" readonly value="<?php echo e($area->name); ?>">
                                        </td>
                                    </tr>
                                </table>
...
<div class="modal show" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" id="NoteDeleteArea">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="background-color: white;color: black;">
        <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
        <button type="button" class="btn btn-primary" onclick="window.location='<?php echo e(route('DeleteArea',$area->areaId)); ?>'">Aceptar</button>
      </div>
    </div>
  </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ICA/resources/views//admins/area/Edit/editArea.blade.php ENDPATH**/ ?>