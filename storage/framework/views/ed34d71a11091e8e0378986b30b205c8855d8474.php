<?php $__env->startSection('content'); ?>
    ...
    <div class="col text-center btn-hover2">
        <a href="<?php echo e(url('/admins/area/addArea')); ?>" class="btn btn-primary" style="margin-right: 3%">
        ...
        <div data-simplebar class="table-responsive table-height">
            ...
            <?php if(empty($areas)): ?>
                <div class="alert alert-danger" >
                    <?php echo e('Agrega un área para empezar a trabajar.'); ?>
                ...
                <div class="col text-center">
                    <table class="table table-striped table-bordered mydatatable">
                        ...
                        <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="td td-center" style="font-size: large"><?php echo e($area->name); ?></td>
                                <td class="td td-center">
                                    <a href="<?php echo e(route('adminViewResults', $area->areaId)); ?>" class="btn-row btn btn-warning"><i class="fas fa-edit"></i> Ir</a>
                                </td>
                                <td class="td td-center">
                                    <a href="<?php echo e(route('showAreaAD', $area->areaId)); ?>" class="btn-row btn btn-info"><i class="fas fa-bookmark"></i> Mostrar</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ICA/resources/views/admins/index.blade.php ENDPATH**/ ?>