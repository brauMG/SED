...
<head>
    ...
    <link href="<?php echo e(asset('bts4/css/email.css')); ?>" rel="stylesheet">
    <title></title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="560" valign="top" align="center">
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="esd-block-image" align="center" style="font-size:0;"><a href="https://sed.work/" target="_blank"><img src="https://i.imgur.com/jkf6qSJ.png" alt="SED logo" title="SED logo" style="max-width: 500px !important; max-height: 150px !important;padding-bottom: 6% !important;padding-right: 6% !important;"></a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text" align="left">
                                                                <h3 style="color: #666666;">Hola, <?php echo e($usuario); ?>, estos son los resultados de tu prueba en SED.<br></h3>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p15t" align="left">
                                                                <?php $__currentLoopData = $aprobadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aprobada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <p style="color: #999999;"><strong><?php echo e($aprobada); ?></strong></p>
                                                        ...
                                                        <?php
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text es-p15t" align="left">
                                                                    ...
                                                                    <p style="color: #999999;"><?php echo e($observacion); ?></p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="esd-block-text es-p15t" align="left">
                                                                    <p style="color: #999999;">Le reviso, <strong><?php echo e($analista); ?></strong>.</p>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p10t es-p15r es-p15l" align="center">
                                                                <p style="font-size: 20px; line-height: 150%;"><?php echo e($telefono); ?></p>
                                                                <p style="font-size: 14px;"><?php echo e($direccion); ?></p>
                                                            </td>
                                                        </tr>
                                                        <tr>
...
<?php /**PATH /var/www/ICA/resources/views/emails/evidence-suggestion.blade.php ENDPATH**/ ?>