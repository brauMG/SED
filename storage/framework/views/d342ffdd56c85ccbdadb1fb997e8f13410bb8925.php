<?php $__env->startSection('content'); ?>
    ...
    <div class="col text-center btn-hover2">
        <a href="<?php echo e(url('/superAdmin/addSponsors/create')); ?>" class="btn btn-primary">
            ...
            <div class="col text-center">
                <table class="table table-striped table-bordered mydatatable">
                    ...
                    <?php $__currentLoopData = $sponsors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="td td-center"><img src="<?php echo e(URL::to('/')); ?>/sponsors/<?php echo e($sponsor->image); ?>" class="img-thumbnail" width="75" /></td>
                                <td class="td td-center"><?php echo e($sponsor -> name); ?></td>
                                <td class="td td-center"><?php echo e(substr($sponsor->description, 0, 115)); ?>...</td>
                                <td class="td td-center"><?php echo e($sponsor -> link); ?></td>
                                <td class="td td-center">
                                    <a href="<?php echo e(route('ShowSponsor', $sponsor->sponsorId)); ?>" class="btn-row btn btn-info"><i class="fas fa-bookmark"></i> Mostrar</a>
                                    <a href="<?php echo e(route('EditSponsor', $sponsor->sponsorId)); ?>" class="btn-row btn btn-warning"><i class="fas fa-edit"></i> Editar</a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ICA/resources/views/superAdmin/viewSponsors/listSponsors.blade.php ENDPATH**/ ?>