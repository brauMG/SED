                ...
                <div class="justify-content-center">
                    <div class="card card-add-company">
                        ...
                        <div class="container-edits">
                            ...
                            <form class="form" id="from" method="POST" action="<?php echo e(route('UpdateUsers',[$User['id']])); ?>">
                                ...
                                <table class="table-responsive table-card-inline" id="tAdmin">
                                    ...
                                    <tr class="tr-card-complete">
                                        ...
                                        <td class="td-card">
                                            <input type="text" name="username" id="usernameU" class="form-control" readonly value="<?php echo e($User['username']); ?>">
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="tr-card-complete">
                                        ...
                                        <td class="td-card">
                                            <input type="text" name="firstName" id="firstNameU" class="form-control" readonly value="<?php echo e($User['firstName']); ?>">
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="tr-card-complete">
                                        ...
                                        <td class="td-card">
                                            <input type="text" name="lastName" id="lastNameU" class="form-control" readonly value="<?php echo e($User['lastName']); ?>">
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="tr-card-complete">
                                        ...
                                        <td class="td-card">
                                            <input type="text" name="emailuser" id="emailuserU" class="form-control" readonly value="<?php echo e($User['email']); ?>">
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="tr-card-complete">
                                        ...
                                        <td class="td-card">
                                            <div id="areauser" class="container" style="text-align: left">
                                                <?php $__currentLoopData = $User_Area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $UA): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo e($UA->name); ?> <br>
                                            ...
                                            <div id="check" style="display:none; text-align: left !important;" class="custom-control custom-checkbox">
                                                ...
                                                <?php $__currentLoopData = $Array_Areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $UA): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if($UA['validar']): ?>
                                                        <input class="form-check-input" type="checkbox" name="checked<?php echo e($UA['areaId']); ?>" value="<?php echo e($UA['areaId']); ?>" id="defaultCheck<?php echo e($UA['areaId']); ?>" checked="true">
                                                    <?php else: ?>
                                                        <input class="form-check-input" type="checkbox" name="checked<?php echo e($UA['areaId']); ?>" value="<?php echo e($UA['areaId']); ?>" id="defaultCheck<?php echo e($UA['areaId']); ?>">
                                                    <?php endif; ?>
                            ...
                            <div class='container'>
                                <a href="<?php echo e(route('EditUser', $User['id'])); ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Editar</a>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" id="DeleteModal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('DeleteUsers', $User['id'])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ICA/resources/views/admins/user/viewUsers/showUser.blade.php ENDPATH**/ ?>