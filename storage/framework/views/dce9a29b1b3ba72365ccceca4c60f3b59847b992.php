                ...
                <div class="justify-content-center">
                    <div class="card card-add-company">
                        ...
                        <div class="card-body">
                            ...
                            <div class='container'>
                                <a href="<?php echo e(route('EditTest', $conceptId)); ?>" class="btn btn-warning"><i class="fas fa-edit"></i> Editar</a>
                                ...
                                <div class="form-edits" style="margin-bottom: 2% !important;">
                                    <table class='table-responsive table-card-inline'>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="testName" class="form-control" readonly value="<?php echo e($testData['name']); ?>">
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="username" class="form-control" readonly value="<?php echo e($test_user_data['username']); ?>">
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="conceptName" class="form-control" readonly value="<?php echo e($test_concept_data['description']); ?>">
                                            </td>
                                        </tr>
                                        ...
                                        <tr class='tr-card-complete'>
                                            ...
                                            <td  class='bold' id="address addy" colspan="2">Nivel de Madurez:
                                                <label style="font-weight: bold"><?php echo e($attribute[0]['ML']); ?></label><br>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute1" class="form-control" readonly value="<?php echo e($attribute[0]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion1" readonly><?php echo e($attribute[0]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute2" class="form-control" readonly value="<?php echo e($attribute[1]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion2" readonly><?php echo e($attribute[1]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute3" class="form-control" readonly value="<?php echo e($attribute[2]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion3" readonly><?php echo e($attribute[2]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class='tr-card-complete'>
                                            <!--Atributo1-->
                                            <td  class='bold' id="address addy" colspan="2">Nivel de Madurez:
                                                <label style="font-weight: bold"><?php echo e($attribute[3]['ML']); ?></label><br>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute4" class="form-control" readonly value="<?php echo e($attribute[3]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion4" readonly><?php echo e($attribute[3]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute5" class="form-control" readonly value="<?php echo e($attribute[4]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion5" readonly><?php echo e($attribute[4]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute6" class="form-control" readonly value="<?php echo e($attribute[5]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion6" readonly><?php echo e($attribute[5]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class='tr-card-complete'>
                                            <!--Atributo1-->
                                            <td  class='bold' id="address addy" colspan="2">Nivel de Madurez:
                                                <label style="font-weight: bold"><?php echo e($attribute[6]['ML']); ?></label><br>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute7" class="form-control" readonly value="<?php echo e($attribute[6]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion7" readonly><?php echo e($attribute[6]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute8" class="form-control" readonly value="<?php echo e($attribute[7]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion8" readonly><?php echo e($attribute[7]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute9" class="form-control" readonly value="<?php echo e($attribute[8]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion9" readonly><?php echo e($attribute[8]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class='tr-card-complete'>
                                            <!--Atributo1-->
                                            <td  class='bold' id="address addy" colspan="2">Nivel de Madurez:
                                                <label style="font-weight: bold"><?php echo e($attribute[9]['ML']); ?></label><br>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute10" class="form-control" readonly value="<?php echo e($attribute[9]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion10" readonly><?php echo e($attribute[9]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute11" class="form-control" readonly value="<?php echo e($attribute[10]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion11" readonly><?php echo e($attribute[10]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute12" class="form-control" readonly value="<?php echo e($attribute[11]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion12" readonly><?php echo e($attribute[11]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class='tr-card-complete'>
                                            <!--Atributo1-->
                                            <td  class='bold' id="address addy" colspan="2">Nivel de Madurez:
                                                <label style="font-weight: bold"><?php echo e($attribute[12]['ML']); ?></label><br>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute13" class="form-control" readonly value="<?php echo e($attribute[12]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion13" readonly><?php echo e($attribute[12]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute14" class="form-control" readonly value="<?php echo e($attribute[13]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion14" readonly><?php echo e($attribute[13]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr-card-complete">
                                            ...
                                            <td class="td-card">
                                                <input type="text" name="attribute15" class="form-control" readonly value="<?php echo e($attribute[14]['AD']); ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="th-card"><i class="fas fa-question-circle"></i> Sugerencia</th>
                                            <td class="td-card">
                                                <div class="form-group">
                                                    <textarea class="form-control" rows="5" name="suggestion15" readonly><?php echo e($attribute[14]['AS']); ?></textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content"style="background-color: #D9534F;color: white;">
                ...
                <div class="modal-footer" style="background-color: white;color: black;">
                    ...
                    <button type="button" class="btn btn-primary" onclick="window.location='<?php echo e(route('DeleteTest', $testId)); ?>'">Aceptar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal show" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" id="DeleteConcept">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content"style="background-color: #D9534F;color: white;">
                ...
                <div class="modal-footer" style="background-color: white;color: black;">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary" onclick="window.location='<?php echo e(route('DeleteConcept',$conceptId)); ?>'">Aceptar</button>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/ICA/resources/views/admins/area/test/showTest.blade.php ENDPATH**/ ?>